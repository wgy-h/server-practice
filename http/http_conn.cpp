...
const char *error_400_form="Your request has bad syntax or inherently impossible to statisfy.\n";
const char *error_403_title="Forbidden";
const char *error_403_form="You do not have permission toget file form this server.\n";
const char *error_404_title="Not Found";
const char *error_404_form="The requested file was not found on this server.\n";
const char *error_500_title="Ineternal Error";
const char *error_500_form="There war an unusal problem serving the request file.\n";
...
{
    return add_response("Connetcion:%s\r\n",(m_linger==true)?"keep-alive":"close");
}
